...
--AUTH_ID는 양쪽 테이블에 모두 존재하기 때문에 SELECT에서 태이블 명을 함께 적어줘야 합니다.
SELECT ID, 
       TITLE,
       INFO.AUTH_ID,
       NAME
...
SELECT * FROM AUTH A LEFT OUTER JOIN INFO I ON A.AUTH_ID = I.AUTH_ID; --위와 동일한 결과가 나온다
