...
SELECT EMPLOYEE_ID 사원번호, (FIRST_NAME || LAST_NAME) 이름, HIRE_DATE 입사일, SALARY 급여 FROM EMPLOYEES;
...
SELECT FIRST_NAME || LAST_NAME || '사원의 급여는' || SALARY || '달러 입니다' "StevenKing 사원의 정보" FROM EMPLOYEES WHERE EMPLOYEE_ID = 100;
